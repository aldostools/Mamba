...
#define umd_mutex_offset (0x64480+0x38C)
	...
	#ifdef PS3M_API
		#define PS3MAPI_FW_VERSION                           0x482
		#define PS3MAPI_FW_TYPE                              "CEX MAMBA"
		#define PS3MAPI_IDPS_1                               0x80000000003E2E30ULL
		#define PS3MAPI_IDPS_2                               0x8000000000474AF4ULL
		#define PS3MAPI_PSID                                 0x8000000000474B0CULL
	...
	#ifdef PS3M_API
		#define PS3MAPI_FW_VERSION                           0x483
		#define PS3MAPI_FW_TYPE                              "CEX MAMBA"
		#define PS3MAPI_IDPS_1                               0x80000000003E2E30ULL
		#define PS3MAPI_IDPS_2                               0x8000000000474AF4ULL
		#define PS3MAPI_PSID                                 0x8000000000474B0CULL
...
#if defined(FIRMWARE_484C) || defined(FIRMWARE_485C) || defined(FIRMWARE_486C) || defined(FIRMWARE_487C) || defined(FIRMWARE_488C) || defined(FIRMWARE_489C)
...
#ifdef sm_get_fan_policy_symbol
