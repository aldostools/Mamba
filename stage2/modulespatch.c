...
{
#ifdef DO_PATCH_COBRA810
	#if defined (FIRMWARE_482C) || defined (FIRMWARE_484C) || defined (FIRMWARE_485C)
	do_patch32(MKA(patch_func8_offset2),     0x48216FB5);
	do_patch32(MKA(lic_patch),               0x48240EED); // ignore LIC.DAT check
	#elif defined (FIRMWARE_482D) || defined (FIRMWARE_484D) || defined (FIRMWARE_485D)
...
#if defined (FIRMWARE_4_82) || defined (FIRMWARE_4_83) || defined (FIRMWARE_4_84)
